...
def evaluate_model(model, x_train, y_train, x_test, y_test):
    #function to train and test models and provide mean absolute error
    #input x and y test-train data and returns mean absolute error
...
def plot_tree(model, filename):
    ...
    #imputs model and name to save model under
